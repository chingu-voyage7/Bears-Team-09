...
```JSON
{
    ...
    "country" : "Canada",
    "city" : "Toronto",
    "datefrom" : "2018-12-07 22:00:00.0",
    "dateto" : "2018-12-07 23:00:00.0",
    "minpeople" : 2,
    "maxpeople" : 3
}
```
...
Required fields: `name`, `activityid`, `maxpeople`

Optional fields: `description`, `placeid`, `datefrom`, `dateto`, `minpeople`
