...
release:
	...
	@ docker-compose -p $(REL_PROJECT) -f $(REL_COMPOSE_FILE) build --pull --build-arg backend_url='https://${DOMAIN_NAME}/api/' --build-arg google_client_id=${GOOGLE_CLIENT_ID} --build-arg google_client_secret=${GOOGLE_CLIENT_SECRET}  frontend
